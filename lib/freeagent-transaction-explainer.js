var FreeAgentTransactionHelper = function(rulesUrl) {
  ...
  var highlight = function(selector) {
    ...
    elements.effect('highlight', 1500);
  };
  ...
  var displayAttachmentMessage = function(shouldHaveAttachment) {
    ...
    var attachmentFormHeading = $('#attachment_form h2');
    ensureExactlyOne(attachmentFormHeading);
    attachmentFormHeading.append(' - ', messageContainer);
